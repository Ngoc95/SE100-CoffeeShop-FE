  ...
  const handleToggleStatus = (id: string) => {
    setSuppliers(suppliers.map(supplier => {
      if (supplier.id === id) {
        ...
        toast.success(newStatus === 'active' ? 'Đã kích hoạt nhà cung cấp' : 'Đã vô hiệu hóa nhà cung cấp');
                  ...
                  {filteredSuppliers.length === 0 ? (
                    ...
                    filteredSuppliers.map((supplier) => (
                      <TableRow key={supplier.id}>
                        <TableCell className="text-slate-900">{supplier.code}</TableCell>
                        ...
                        <TableCell className="text-slate-900">
                          <span className={supplier.debt > 0 ? 'text-red-600' : 'text-slate-600'}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              ...
                              className={supplier.status === 'active' ? 'text-red-600 hover:text-red-700 hover:bg-red-50' : 'text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50'}
