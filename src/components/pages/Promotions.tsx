...
import { Plus, Edit, Trash2, Search, Power, PowerOff, Filter, X, Upload, Download, Printer } from 'lucide-react';
        ...
        <div className="bg-white border-b p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-slate-600 text-sm">Quản lý chương trình khuyến mại</p>
            </div>
