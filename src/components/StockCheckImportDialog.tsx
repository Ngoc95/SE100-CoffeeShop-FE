...
export function StockCheckImportDialog({ open, onOpenChange }: StockCheckImportDialogProps) {
    ...
    const getTemplateColumns = () => {
        return ['Mã hàng', 'Tên hàng hóa', 'Đơn vị', 'Số lượng thực tế', 'Ghi chú'];
    };
    ...
    const processFile = (file: File) => {
        ...
        const mockData: PreviewRow[] = [
            ...
            },
            {
                ...
                name: 'Đường trắng',
                unit: 'kg',
                realQty: '', // Missing quantity
                note: '',
                status: 'error',
                errors: ['Thiếu số lượng thực tế']
            },
            {
                id: '4',
                code: 'CF004',
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-xs text-slate-600 mb-3">
                            File mẫu đã được thiết lập sẵn các cột dữ liệu kiểm kho
                        </p>
                        <Button
                            size="sm"
                            variant="outline"
            ...
            <div className="bg-slate-50 rounded-lg p-4">
                ...
                <ul className="text-xs text-slate-600 space-y-2">
                    <li className="flex gap-2">
                        ...
                        <span>Tải file mẫu Excel kiểm kho</span>
                    </li>
                    <li className="flex gap-2">
                        <span className="text-blue-600">2.</span>
                        <span>Điền số lượng thực tế kiểm kê được vào file</span>
                    </li>
                    <li className="flex gap-2">
                    ...
                    <li className="flex gap-2">
                        ...
                        <span>Xác nhận để tạo phiếu kiểm kho</span>
                    </li>
                </ul>
            </div>
                    ...
                    <TableBody>
                        {previewData.map((row, idx) => (
                            <TableRow key={row.id}>
                                ...
                                <TableCell>{row.realQty}</TableCell>
        ...
        <div className="space-y-6 py-8">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <p className="text-sm text-slate-700 text-center">
                    {importStats.success > 0 && `${importStats.success} mặt hàng được cập nhật số lượng kiểm kho. `}
    ...
    return (
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle>Import Phiếu Kiểm Kho</DialogTitle>
                </DialogHeader>
